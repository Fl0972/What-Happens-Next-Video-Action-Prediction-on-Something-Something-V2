...
# Find uv (same logic as ablation_lib.sh).
...
# ---------------------------------------------------------------------------
declare -a EXPS=(
    "A|ablation_tsm_no_focal_rotating|200|ablation_tsm_no_focal_rotating"
    "B|ablation_vfl_2layers_rotating|150|ablation_vfl_2layers_rotating"
    "C|ablation_tsm_focal_g1_rotating|200|ablation_tsm_focal_g1_rotating"
    "D|ablation_vfl_folds10_rotating|150|ablation_vfl_folds10_rotating"
    "E|ablation_tsm_sgdr_t2_rotating|200|ablation_tsm_sgdr_t2_rotating"
    "F|ablation_vfl2_sgdr_t2_rotating|200|ablation_vfl2_sgdr_t2_rotating"
    "G|ablation_tsm_onecycle_rotating|200|ablation_tsm_onecycle_rotating"
    "H|ablation_vfl2_onecycle_rotating|200|ablation_vfl2_onecycle_rotating"
)
...
crontab -l 2>/dev/null | grep -E '(ablation_[ABCD]_run|ABLATION_EXP)' \
    | sed 's/^/  /' \
    || printf '  (none installed — run setup_ablation_crons.sh)\n'
printf '%s\n\n' "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
