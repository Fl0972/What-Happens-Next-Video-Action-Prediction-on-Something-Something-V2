...
#
# REMOVE
#   bash scripts/trackA_cancel_ablation_crons.sh
...
declare -A RUNNERS=(
    [A]="$SCRIPTS_DIR/trackA_ablation_A_run.sh"
    [B]="$SCRIPTS_DIR/trackA_ablation_B_run.sh"
    [C]="$SCRIPTS_DIR/trackA_ablation_C_run.sh"
    [D]="$SCRIPTS_DIR/trackA_ablation_D_run.sh"
    [E]="$SCRIPTS_DIR/trackA_ablation_E_run.sh"
    [F]="$SCRIPTS_DIR/trackA_ablation_F_run.sh"
    [G]="$SCRIPTS_DIR/trackA_ablation_G_run.sh"
    [H]="$SCRIPTS_DIR/trackA_ablation_H_run.sh"
)
...
echo ""
echo "Run 'bash scripts/trackA_cancel_ablation_crons.sh' to remove all ablation entries."
echo "Run 'bash scripts/trackA_status_ablations.sh' to check experiment progress."
